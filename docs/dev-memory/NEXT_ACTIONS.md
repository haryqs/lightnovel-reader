...
## 📌 交接留言（2026-08-22，v0.7.3 已正式公开并完成跨版本复验）
...
1. **合并数据备份体验**：提交 core、桥接、书库入口、协议与 P0 增强，等待 PR/main CI 全绿后合并；发下一版前人工点击一次 Windows 目录选择器。
2. **设计恢复前置校验**：先实现只读 manifest/schema/SHA-256 校验与内容预览，明确版本兼容和冲突策略；没有预览与二次确认前不得覆盖现有 app data。
