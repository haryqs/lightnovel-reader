...
1. **准备 v0.7.1 维护版本**：优先收集 v0.7.0 的安装、启动、阅读和插件来源反馈，修复首发问题，不轮换
   updater 密钥。
2. **完成真实跨版本 updater 验证**：发布 v0.7.1 时，从公开安装的 v0.7.0 验证检查、下载、安装、重启与
   用户数据保留；v0.7.0 是新信任根下的首个公开版本，因此不能对自身完成这项验证。
