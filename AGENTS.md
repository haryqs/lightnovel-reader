...
2. **当前主线 v0.7 首发维护**：v0.7.0 已正式公开，QuickJS、正式 `source.*`、合法开放 EPUB 获取、真实离线窗口 smoke、每域限速/ToS、Ed25519 包验签、Gutenberg 正式仓库及 updater/安装器公开分发均已落地；下一发布目标是 v0.7.1，并用公开 v0.7.0 完成真实跨版本自动更新验证。
