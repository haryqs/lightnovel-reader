...
2. **当前主线 v0.7 首发维护**：v0.7.1 已正式公开，v0.7.2 源码候选正在准备；QuickJS、正式 `source.*`、合法开放 EPUB 获取、真实离线窗口 smoke、每域限速/ToS、Ed25519 包验签、Gutenberg 正式仓库及应用内 updater/安装器公开分发均已落地；下一步以公开 v0.7.1 为旧版本，完成到 v0.7.2 的完整用户界面更新闭环。
