...
2. **当前主线 v0.7 首发维护**：v0.7.2 已正式公开为 Latest Release，且从正式安装的 v0.7.1 完成了检查、详情、下载、验签、安装、重启及数据保留闭环。开发线已升至 v0.7.3，修复桌面 PWA 缓存污染和多语言 NSIS 被 `passive` 安装模式阻塞的问题；下一步完成 v0.7.3 合并、签名候选与发布复验。
