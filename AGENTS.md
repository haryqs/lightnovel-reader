...
2. **当前主线 v0.7 插件来源收口**：QuickJS、正式 `source.*`、合法开放 EPUB 获取、真实离线窗口 smoke、每域限速/ToS、Ed25519 包验签及首批正式发布公钥均已落地；首个 Gutenberg 候选仓库已用正式私钥签署并留在仓库外，待完成 updater/安装器发布演练、正常公网 DNS 复验及正式 GitHub Release。
