...
2. **当前主线 v0.7 首发维护**：v0.7.2 已正式公开为 Latest Release；v0.7.3 的桌面 PWA 缓存与 Windows quiet updater 修复已合入 `main@60c0868`，签名五资产、安装/卸载和数据保留均已验收并上传 Draft。下一步必须先取得维护者明确公开授权，再从 v0.7.2 完成到 v0.7.3 的真实在线更新复验。
