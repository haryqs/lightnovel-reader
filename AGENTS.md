...
2. **当前主线 v0.7 首发维护**：v0.7.0 已正式公开，QuickJS、正式 `source.*`、合法开放 EPUB 获取、真实离线窗口 smoke、每域限速/ToS、Ed25519 包验签、Gutenberg 正式仓库及 updater/安装器公开分发均已落地；当前正在准备首个带应用内更新入口的 v0.7.1。公开 v0.7.0 只能做底层 updater 链验证，完整用户界面更新闭环应从 v0.7.1 更新到后续版本验证。
